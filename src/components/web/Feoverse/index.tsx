...
const Index = () => {
  return <div className='web-home-feoverse'>
    <h1>FEOVERSE</h1>
    <p>The FEOVerse will offer an immersive metaverse in which fans and<br /> collectors can stake their claim in a new and collaborative world of collecting.</p>
